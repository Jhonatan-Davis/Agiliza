...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/views/painel_dono/style_painel.css?v=<?= filemtime(__DIR__ . '/style_painel.css') ?>">
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-card card-meu-perfil">
                    ...
                    <div class="perfil-info-card">
                        <img src="<?php echo public_asset_url($negocio['foto_perfil_url'] ?: 'uploads/default_perfil.png'); ?>" alt="Logo do Negócio">
                        <strong><?php echo htmlspecialchars($negocio['nome_negocio']); ?></strong>
                        <span>Proprietário(a)</span>
                        <a href="<?= BASE_URL ?>/views/cliente/perfil_negocio.php?id=<?php echo $id_negocio; ?>" target="_blank" class="perfil-negocio-link" style="margin-top: 1rem;">
