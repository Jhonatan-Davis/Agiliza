                ...
                <form action="processar_meu_negocio.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($negocio['foto_perfil_url'])): ?>
                            <div class="preview-container">
                                <img src="<?php echo public_asset_url($negocio['foto_perfil_url']); ?>" alt="Foto de Perfil Atual" class="preview-perfil">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($negocio['capa_url'])): ?>
                            <div class="preview-container">
                                <img src="<?php echo public_asset_url($negocio['capa_url']); ?>" alt="Capa Atual">
                                <small>Deixe em branco para manter a atual.</small>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?= BASE_URL ?>/views/cliente/perfil_negocio.php?id=<?php echo $_SESSION['id_negocio']; ?>" target="_blank" class="preview-button">
