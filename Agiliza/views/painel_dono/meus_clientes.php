...
<body>
    <div class="painel-container">
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-logout"><a href="<?= BASE_URL ?>/controllers/logout.php">Sair</a></div>
        </nav>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-card" style="padding: 0; overflow: hidden;">
                <table class="tabela-agenda clientes-table" style="margin-top: 0; border: none; box-shadow: none;">
                    <thead>
                        <tr>
                            <th>Cliente</th>
                            <th>Contato</th>
                                ...
                                <tr>
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 10px;">
                                            <img src="<?php echo public_asset_url($cli['foto_perfil_url'] ?? 'uploads/default_perfil.png'); ?>"
