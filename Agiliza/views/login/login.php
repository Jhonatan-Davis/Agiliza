...
if (isset($_SESSION['usuario_id'])) {
    if ($_SESSION['funcao'] == 'dono') {
        ...
        header("Location: " . BASE_URL . "/views/painel_funcionario/index.php");
    } else {
...
<body>
    <div class="login-container">
        ...
        <?php
            ...
            if ($erro_login) {
                echo '<div class="error-message">' . htmlspecialchars($erro_login) . '</div>';
            }
            if (isset($_GET['erro'])) {
        ...
        <form action="<?= BASE_URL ?>/views/login/processar_login.php" method="POST" autocomplete="off">
        ...
        <div class="login-links">
            <a href="<?= BASE_URL ?>/cadastro/selecao.php">Não tem uma conta? Cadastre-se</a>
            <br><br>
            <a href="<?= PUBLIC_URL ?>/index.php" style="color: #555; font-weight: normal;">&larr; Voltar ao site</a>
        </div>
    </div>
