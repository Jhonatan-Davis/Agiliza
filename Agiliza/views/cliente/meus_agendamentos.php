...
<body>
    ...
    <main class="site-container">
        <div class="appointments-page-heading">
            <div>
                <span class="eyebrow">Sua agenda</span>
                <h1>Meus Agendamentos</h1>
                <p>Acompanhe seus próximos horários e consulte o que já foi realizado.</p>
            </div>
            <a href="<?= PUBLIC_URL ?>/index.php" class="appointments-new-link">
        ...
        <div class="appointments-section-heading">
            ...
            <span class="appointments-count"><?php echo count($proximos_agendamentos); ?> <?php echo count($proximos_agendamentos) === 1 ? 'horário' : 'horários'; ?></span>
        </div>
        <div class="appointments-list">
                ...
                <?php foreach ($proximos_agendamentos as $ag): ?>
                    ...
                    <div class="appointment-card">
                        ...
                        <div class="card-actions">
                            ...
                            <a href="<?= BASE_URL ?>/controllers/AgendamentoController.php?action=cancelar&id=<?php echo $ag['id']; ?>"
            ...
            <?php else: ?>
                <div class="empty-message">
                    <span class="empty-message-icon"><i class="fas fa-calendar-plus"></i></span>
                    <h3>Nenhum horário marcado</h3>
                    <p>Encontre um estabelecimento e reserve seu próximo atendimento.</p>
                    <a href="<?= PUBLIC_URL ?>/index.php" class="appointments-empty-link">Encontrar estabelecimento <i class="fas fa-arrow-right"></i></a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <?php if (count($historico_agendamentos) > 0): ?>
            <div class="appointments-section-heading">
                ...
                <span class="appointments-count muted"><?php echo count($historico_agendamentos); ?> <?php echo count($historico_agendamentos) === 1 ? 'registro' : 'registros'; ?></span>
            </div>
            <div class="appointments-list">
                <?php foreach ($historico_agendamentos as $ag): ?>
                    ...
                    <div class="appointment-card is-past">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <p class="status-badge status-<?php echo htmlspecialchars($ag['status']); ?>"><?php echo htmlspecialchars(ucfirst($ag['status'])); ?></p>
                            <?php endif; ?>
                        </div>
