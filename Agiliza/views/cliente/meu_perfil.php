...
<head>
    ...
    <link rel="stylesheet" href="<?= PUBLIC_URL ?>/css/style_site.css">
...
<body>
    ...
    <header class="site-header">
        <a href="<?= PUBLIC_URL ?>/index.php" class="logo">Agili<span>za</span></a>
        ...
        <nav>
            <div class="user-dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="<?= BASE_URL ?>/controllers/logout.php" class="logout-link">Sair</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <main class="site-container">
        ...
        <div class="profile-layout">
            ...
            <div class="profile-card profile-editor-card">
                ...
                <form action="<?= BASE_URL ?>/controllers/processar_perfil.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="profile-form-grid">
                        <div class="form-group profile-photo-field">
                            ...
                            <div class="form-group-file">
                                ...
                                <span class="file-input-filename" id="filename-perfil"><i class="fas fa-image"></i> Nenhum arquivo escolhido</span>
                            </div>
                        ...
                        <div class="profile-fields-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" class="search-input" 
        ...
        <div class="security-action-card">
            <div>
                <span class="security-action-icon"><i class="fas fa-lock"></i></span>
                <div>
                    <h3>Segurança da conta</h3>
                    <p>Atualize sua senha sempre que precisar.</p>
                </div>
            </div>
            <button type="button" class="outline-button" id="open-password-modal">
                <i class="fas fa-key"></i> Alterar senha
            </button>
        </div>
    </main>

    <div class="password-modal<?php echo (isset($_SESSION['erro_senha']) || isset($_SESSION['sucesso_senha'])) ? ' is-open' : ''; ?>" id="password-modal" aria-hidden="<?php echo (isset($_SESSION['erro_senha']) || isset($_SESSION['sucesso_senha'])) ? 'false' : 'true'; ?>">
        <div class="password-modal-backdrop" data-close-password-modal></div>
        <section class="password-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="password-modal-title">
            <button type="button" class="password-modal-close" data-close-password-modal aria-label="Fechar">
                <i class="fas fa-times"></i>
            </button>
            <span class="modal-kicker">Segurança</span>
            ...
            ?>
            <form action="<?= BASE_URL ?>/controllers/processar_perfil.php" method="POST">
...
<script>
    ...
    if (passwordModal && openPasswordModal) {
        ...
        passwordModal.querySelectorAll('[data-close-password-modal]').forEach((element) => {
