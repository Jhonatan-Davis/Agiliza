                    ...
                    <div class="dropdown-content">
                        <?php if ($e_proprietario): ?>
                            <?php if ($_SESSION['funcao'] == 'dono'): ?>
                                <a href="<?= BASE_URL ?>/views/painel_dono/index.php">Ir para meu Painel</a>
                            <?php else: ?>
                                <a href="<?= BASE_URL ?>/views/painel_funcionario/index.php">Ir para meu Painel</a>
                            <?php endif; ?>
                        <?php else: ?>
    ...
    <script>
        ...
        if (favoriteBtn) {
            favoriteBtn.addEventListener('click', async () => {
                ...
                try {
                    const response = await fetch('<?= BASE_URL ?>/controllers/favoritar_negocio.php', {
                        method: 'POST',
