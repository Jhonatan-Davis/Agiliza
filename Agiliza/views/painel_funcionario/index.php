    ...
    <div class="painel-container">
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-logout">
                <a href="<?= BASE_URL ?>/controllers/logout.php">Sair</a>
            </div>
        </nav>
            ...
            <div class="dashboard-grid">
                        ...
                        <?php if (count($proximos_clientes) > 0): ?>
                            <?php foreach ($proximos_clientes as $ag): ?>
                                <div class="cliente-item">
                                    ...
                                    <a href="<?= BASE_URL ?>/views/cliente/chat.php?id=<?php echo $ag['id']; ?>" class="icon-btn chat-link" title="Abrir Chat">
                ...
                <div class="dashboard-card card-meu-perfil">
                    ...
                    <div class="perfil-info-card">
                        <div>
                            <img src="<?php echo public_asset_url($funcionario['foto_perfil_url'] ?: 'uploads/default_perfil.png'); ?>" alt="Sua Foto">
                            <strong><?php echo htmlspecialchars($funcionario['nome']); ?></strong>
                            <span><?php echo htmlspecialchars($funcionario['email']); ?></span>
                        </div>

                        <a href="<?= BASE_URL ?>/views/cliente/perfil_negocio.php?id=<?php echo $id_negocio; ?>" target="_blank" class="perfil-negocio-link">
                    ...
                    <div class="lista-chats-scroll">
                        <?php if (count($ultimos_chats) > 0): ?>
                            <?php foreach ($ultimos_chats as $chat): ?>
                                <a href="<?= BASE_URL ?>/views/cliente/chat.php?id=<?php echo $chat['agendamento_id']; ?>" class="chat-item">
                                    <div class="chat-item-foto">
                                        <img src="<?php echo public_asset_url($chat['cliente_foto'] ?: 'uploads/default_perfil.png'); ?>" alt="Foto Cliente">
                                    </div>
