...
<body>
    ...
    <header class="site-header">
        ...
        <nav>
                ...
                <div style="display: flex; align-items: center;">
                    ...
                    <div class="user-dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="<?= BASE_URL ?>/views/cliente/meu_perfil.php">Meu Perfil</a>
                            <a href="<?= BASE_URL ?>/views/cliente/meus_agendamentos.php">Meus Agendamentos</a>
            ...
            <?php else: ?>
                <a href="<?= BASE_URL ?>/views/login/login.php">Fazer Login</a>
                <a href="<?= BASE_URL ?>/cadastro/selecao.php" class="form-button" style="padding: 0.5rem 1rem; margin-left: 1rem;">Cadastre-se</a>
            <?php endif; ?>
        </nav>
    </header>
    ...
    <?php if ($visitante): ?>
        ...
        <div class="hero-section">
            ...
            <a href="<?= BASE_URL ?>/cadastro/selecao.php" class="form-button">Cadastre-se Gratuitamente</a>
        </div>
    ...
    <?php else: ?>
        ...
        <main class="site-container">
            <div class="directory-heading">
                <div>
                    <span class="eyebrow">Diretório Agiliza</span>
                    <h2>Encontre um estabelecimento</h2>
                    <p>Busque por nome ou descubra opções por categoria.</p>
                </div>
                <span class="directory-heading-icon"><i class="fas fa-compass"></i></span>
            </div>
            ...
            <div class="business-grid">
                ...
                <?php else: ?>
                    <div class="empty-directory-state">
                        <span class="empty-directory-icon"><i class="fas fa-store-slash"></i></span>
                        <h3>Nenhum estabelecimento encontrado</h3>
                        <p>Tente remover um filtro ou buscar por outro nome para encontrar o atendimento ideal.</p>
                        <a href="<?= PUBLIC_URL ?>/index.php" class="empty-directory-link">Limpar busca <i class="fas fa-arrow-right"></i></a>
                    </div>
                <?php endif; ?>
            </div>
        </main>
    ...
    <?php require APP_ROOT . '/views/cliente/footer.php'; ?>
